...
left join (select ad_group_id, gender_id, date, impressions, clicks, video_views, cost, video_played_to_25_percent, video_played_to_50_percent, video_played_to_75_percent, video_played_to_100_percent from adwords.aw_gender_summary_daily where impressions >0 and date>= '2018-01-01') as d
